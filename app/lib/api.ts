...
export type TrnPodiumEntry = { rnk: number; value: number; achieved_on: string };
export type TrnPodiumRec = { category: string; metric: string; scope_label: string; unit: string; entries: TrnPodiumEntry[] };
export type TrnPodium = { running: TrnPodiumRec[]; strength: TrnPodiumRec[]; swim: TrnPodiumRec[] };
export type TrnPrs = { records: { strength: TrnRecord[]; running: TrnRecord[]; swim: TrnRecord[] }; projections: TrnProjection[]; projection_base_km: number; stats: TrnStats; podium?: TrnPodium };
