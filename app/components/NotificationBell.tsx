...
export default function NotificationBell() {
  ...
  return (
    <div ref={wrapRef} style={{ position: "relative", display: "inline-flex" }}>
      ...
      {open && (
        <div style={{ position: "absolute", top: 42, right: 0, width: 300, maxWidth: "86vw", background: RAISED, border: "1px solid " + BORDER_STRONG, borderRadius: 14, boxShadow: "0 12px 32px rgba(0,0,0,.4)", zIndex: 60, overflow: "hidden" }}>
